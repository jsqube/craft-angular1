 ...
 */
describe('crud-service-rest', function () {
    ...
    beforeEach(inject(function ($injector,$window) {
        ...
        $httpBackend.whenRoute('GET', 'http://localhost:9876/craft/api/:repoName/:methodName/:pageSize/:pageIndex')
        ...
        $httpBackend.whenRoute('GET', 'http://localhost:9876/craft/api/:repoName')
            .respond(function (method, url, data, headers, params) {
        ...
        $httpBackend.whenRoute('GET', 'http://localhost:9876/craft/api/:repoName/:id')
            .respond(function (method, url, data, headers, params) {
                //console.log(params.repoName, params.methodName, params.pageIndex,params.pageSize);
        ...
        $httpBackend.whenRoute('POST', 'http://localhost:9876/craft/api/:repoName')
            .respond(function (method, url, data, headers, params) {
        ...
        $httpBackend.whenRoute('PUT', 'http://localhost:9876/craft/api/:repoName/:id')
            .respond(function (method, url, data, headers, params) {
        ...
        $httpBackend.whenRoute('DELETE', 'http://localhost:9876/craft/api/:repoName/:id')
            .respond(function (method, url, data, headers, params) {
                //find the role data and update it
        ...
        $httpBackend.whenRoute('POST', 'http://localhost:9876/craft/api/:serviceName/:funcName')
            .respond(function (method, url, data, headers, params) {
                responseBody.data = "success";
                return [200, responseBody];
            });
    ...
    it('should fetch all data with list method', function () {
        $httpBackend.expectGET('http://localhost:9876/craft/api/role');
    ...
    it('should save data with post method', function () {
        $httpBackend.expectPOST('http://localhost:9876/craft/api/role');
        ...
        // $httpBackend.expectGET('http://localhost:9876/craft/api/role/4');
        // var result = crudService.find('role', 4);
        // $httpBackend.flush();
        // result.then(function (data) {
        //     expect(data.data).toEqual({"id": 4, "roleName": "test", "desc": "test", "rights": []});
        // }).catch(function (reason) {
        // });
    });
    it('should save data with put method', function () {
        $httpBackend.expectPUT('http://localhost:9876/craft/api/role/3');
        var result = crudService.update('role', 3, {"id": 5, "roleName": "test5", "desc": "test5","rights":[]});
        $httpBackend.flush();
        result.then(function (data) {
            expect(data).toEqual({ version: '1.0', errorCode: 0, errorMsg: null, data: 'success' });
        }, function (reason) {
        });
        // $httpBackend.expectGET('http://localhost:9876/craft/api/role/findById?params=[3]');
    ...
    it('should delete data with delete method', function () {
        $httpBackend.expectDELETE('http://localhost:9876/craft/api/role/4');
    ...
    it('should fetch page data with findByCriteriaPageable method', function () {
        $httpBackend.expectGET('http://localhost:9876/craft/api/role/findByPage/2/1');
