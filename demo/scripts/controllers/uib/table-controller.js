(function () {
    angular.module('tables',[]).controller('TablesDemoCtrl', function ($scope, $http, $rootScope, DTOptionsBuilder, DTColumnDefBuilder) {
...
//Controller for selectAll checkbox
    angular.module('tables').controller('SelectTableCtrl', function ($scope, $rootScope) {
